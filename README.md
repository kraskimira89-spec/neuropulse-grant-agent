...
- **Доступ к API (аутентификация, URL, вызов агента)** — способы аутентификации, базовые URL, формат `gpt://folder_id/agent_id`, работа с файлами и индексами: [docs/Доступ-к-API-Yandex-AI-Studio.md](docs/Доступ-к-API-Yandex-AI-Studio.md).
